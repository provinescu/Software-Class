...
HPgenomeEditorAllInOne {
	...
	*new	{arg agent=0;
	...
	edit {arg agent, listeView=[];
		...
		StaticText(~wEditor, Rect(0, 0, 500, 18)).string_("A Genome Editor for Agents").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 14));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Ageing").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Moving").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Agent Vision").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Signal Vision").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Fhz Low").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Fhz Range").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Translate Fhz").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Amplitude Low").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Amplitude Range").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Duration Low").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Duration Range").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Duration Mul").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Panoramic").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Buffer Duration").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Sounds").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Reverse Sound").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Loop Sound").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Offset Sound").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Envelopes").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Synthesizeur").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Control 1").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Control 2").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Control 3").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Audio Out").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Midi Out").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Audio In").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Loop Music").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Buffer Music").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Chord Max").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Chord Dur").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Algorithm").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		...
		~wEditor.view.decorator.nextLine;
		StaticText(~wEditor, Rect(0, 0, 300, 18)).string_("Fhz Band").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
