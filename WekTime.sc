...
WekTime {
	...
	classvar  <> s, sender, dimIn, choiceFilter, choiceFX, flagStreamMFCC, mfccData, numPreset, lastNumPreset, lastTimeWekPreset, timeWekPreset, listeWekPreset, timeWekData, lastTimeWekData, flagWTD, flagWTP, numSequencer, wekBPM, scAdr, udpAdr;
	...
	*new	{arg path="~/Documents/WekTime/", ni=2, numberOut=2, numberRec=2, format=0, devIn="Built-in Microph", devOut="Built-in Output", size = 256, wid=2.0, ori=0.5, flag=0, name="WekTime", wek=6448, wekPort=57120, scPort=57110;
...
";
		...
		s.waitForBoot({
			...
			// OSC Data
			OSCFunc.newMatching({arg msg, time, addr, recvPort;
				var freq, octave, oct, ratio, degre, difL, difH, pos=scale.degrees.size - 1, demiTon, cent, amp, duree, indexNumFhzBand, data=[], mfcc, tamponSynth, tamponDurSynth, tamponModSynth, freqBand;
			...
			MIDIdef.noteOn(\midiNoteOn, {arg amp, freq, canal, src;
				var octave, oct, ratio, degre, difL, difH, pos=scale.degrees.size - 1, demiTon, cent, duree, indexNumFhzBand, time = Main.elapsedTime, data,  tamponSynth, tamponDurSynth, tamponModSynth, freqBand;
