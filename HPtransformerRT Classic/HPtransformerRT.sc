/* HPtransformerRT V30.3.0 RELEASE - SuperCollider 3.14 class source.
...
non-destructive interference probe. V30.3.0 adds robust online conditioning,
    ...
    *new { |
    ...
    resetLearning {
        ^{
                ...
                metaLearnRetrievalGainMax = 0.30;
                    "V30.3.0 Learning+ Dynamic Trajectory Memory runtime and optimizer reset / weights and memories preserved".postln;
                    nil;
    ...
    resetMemory {
        ^{
                    ...
                    Array.new;
                    protectionScalar = 0.0;
                    "V30.3.0 Learning+ Dynamic Trajectory Memory memory reset".postln;
                    nil;
    ...
    resetAll {
        ^{
                    ...
                    // ------------------------------------------------------------
                    this.resetLearning;
                    "V30.3.0 Learning+ Dynamic Trajectory Memory full reset".postln;
                    nil;
    ...
    status {
        ^{
                    ...
                    "".postln;
                    "============================================================".postln;
                    "TRANSFORMER VECTOR V30.3.0 Learning+ Dynamic Trajectory Memory".postln;
    ...
    saveArchive { |path|
        ...
        ("HPtransformerRT V30.3.0 saved: " ++ finalPath).postln;
        ^finalPath;
    }
    *readArchive { |path|
        var finalPath, model;
        ...
        ("HPtransformerRT V30.3.0 restored: " ++ finalPath).postln;
        ^model;
    }
