...
";
		...
		s.waitForBoot({
			...
			//file.close;
			//windowControlGUI.name="Time a Interactive and Organizer Musical Software by Provinescu's Software Production" + " | " +  "Init Preset"},{"Canceled".postln});
