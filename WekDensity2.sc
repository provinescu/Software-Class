...
WekDensity2 {
	...
	*new {arg path = "~/Documents/WekDensity2/", ni = 8, numberOut=2, numberRec=2, format=0, devIn="Built-in Microph", devOut="Built-in Output", size = 512, wid=2.0, ori=0.5, flag=0, name="WekDensity", wek=6448, wekPort=57120, scPort=57110;
