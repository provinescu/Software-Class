...
HPgenomeEditorSlider {
	...
	*new	{arg agent=0;
	...
	edit {arg agent, genome, listeView=[];
		...
		~wEditor = Window("Genomes Editor for Agents by HP", Rect(10, 10, 650, 735), scroll: true);
		...
		// Menu Genome
		~menuGenome = PopUpMenu(~wEditor,Rect(0, 0, 150, 20)).items = ["Genomes Menu", "Load Genome",  "Load Genomes", "Save Genome", "Save Genomes"];
		...
		StaticText(~wEditor, Rect(0, 0, 50, 18)).string_("Agent").stringColor_(Color.yellow(1.0,1.0));
		...
		// Copy Genome
		~fonctionCopyGenome = Button(~wEditor,Rect(0, 0, 175, 20)).states=[["->   Copy Genome   ->", Color.white, Color.red(0.8, 0.25)]];
		...
		~wEditor.view.decorator.nextLine;
		~ag0 = EZKnob(~wEditor, 175@25, "Ageing", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(0), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag0);
		~ag1 = EZKnob(~wEditor, 175@25, "Moving", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(1), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag1);
		~ag2 = EZKnob(~wEditor, 175@25, "Agent Vision", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(2), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag2);
		~ag3 = EZKnob(~wEditor, 175@25, "Signal Vision", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(3), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		...
		~wEditor.view.decorator.nextLine;
		~ag4 = EZKnob(~wEditor, 175@25, "Fhz Low", ControlSpec(0, 127, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(4)*127, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag4);
		~ag5 = EZKnob(~wEditor, 175@25, "Fhz Range", ControlSpec(0, 127, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(5)*127, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag5);
		~ag6 = EZKnob(~wEditor, 175@25, "Translate Fhz", ControlSpec(-127, 127, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(6) * 254 - 127, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag6);
		~wEditor.view.decorator.nextLine;
		~ag7 = EZKnob(~wEditor, 175@25, "Amplitude Low", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(7), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag7);
		~ag8 = EZKnob(~wEditor, 175@25, "Amplitude Range", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(8), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag8);
		~wEditor.view.decorator.nextLine;
		~ag9 = EZKnob(~wEditor, 175@25, "Duration Low", ControlSpec(0, 60, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(9), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag9);
		~ag10= EZKnob(~wEditor, 175@25, "Duration Range", ControlSpec(0, 60, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(10), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag10);
		~ag11= EZKnob(~wEditor, 175@25, "Duration Mul", ControlSpec(-16, 64, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(11) * 80 - 16, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		...
		~wEditor.view.decorator.nextLine;
		~ag12= EZKnob(~wEditor, 175@25, "Panoramic", ControlSpec(-1, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(12) * 2 - 1, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		...
		~wEditor.view.decorator.nextLine;
		~ag13= EZKnob(~wEditor, 175@25, "Buffer Duration", ControlSpec(0.015625, ~tempsmaxsignal, \lin, 0),
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(13) * ~tempsmaxsignal, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag13);
		StaticText(~wEditor, Rect(0, 0, 50, 18)).string_("Sounds");
		~ag14= PopUpMenu(~wEditor, 190@25).items_(~displaySons);
		~ag14.action={arg son;
		...
		~wEditor.view.decorator.nextLine;
		~ag15= EZKnob(~wEditor, 175@25, "Reverse Sound", ControlSpec(-1, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(15) * 2 - 1, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag15);
		~ag16= EZKnob(~wEditor, 175@25, "Loop Sound", ControlSpec(-1, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(16) * 2 - 1, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag16);
		~ag17= EZKnob(~wEditor, 175@25, "Offset Sound", ControlSpec(0, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(17), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag17);
		~wEditor.view.decorator.nextLine;
		// Env Genome
		StaticText(~wEditor, Rect(0, 0, 525, 18)).string_("Envelopes Genome").stringColor_(Color.yellow(1.0,1.0)).font_(Font("Georgia", 12));
		~wEditor.view.decorator.nextLine;
		...
		~ag34= PopUpMenu(~wEditor, 190@25).items_(~listSynth);
		...
		StaticText(~wEditor, Rect(0, 0, 125, 18)).string_("Controls Synthesizeur").stringColor_(Color.white(1.0,1.0)).font_(Font("Georgia", 12));
		~ag35=MultiSliderView(~wEditor, Rect(0, 0, 150, 90));
		~ag35.value_([0, 0, 0]);
		~ag35.fillColor_(Color(0, 0.25, 0.5));
		~ag35.strokeColor_(Color.cyan);
		~ag35.xOffset_(1.0);
		~ag35.thumbSize_(40);
		~ag35.elasticMode_(1);
		~ag35.action={arg controls;
			~fonctionRecordScore.value("~ag35", controls.value);
			genome=~genomes.wrapAt(~agentEditor-1 );
			genome.wrapPut(35, controls.value.wrapAt(0));
			genome.wrapPut(36, controls.value.wrapAt(1));
			genome.wrapPut(37, controls.value.wrapAt(2));
			~genomes.wrapPut(~agentEditor-1, genome);
		};
		listeView=listeView.add(~ag35);
		listeView=listeView.add(nil);// 36
		listeView=listeView.add(nil);// 37
		//~ag35= EZKnob(~wEditor, 50@100, "Control1", ControlSpec(0, 1, \lin, 0),
		//{arg view;
		//genome=~genomes.wrapAt(~agentEditor-1 );genome.wrapPut(35, view.value);~genomes.wrapPut(~agentEditor-1, genome);
		//~flagGene=35;
		//},
		//~genomes.wrapAt(~agentEditor-1 ).wrapAt(35), labelWidth:50, numberWidth:35, layout: \vert);
		//listeView=listeView.add(~ag35);
		//~ag36= EZKnob(~wEditor, 50@100, "Control2", ControlSpec(0, 1, \lin, 0),
		//{arg view;
		//genome=~genomes.wrapAt(~agentEditor-1 );genome.wrapPut(36, view.value);~genomes.wrapPut(~agentEditor-1, genome);
		//~flagGene=36;
		//},
		//~genomes.wrapAt(~agentEditor-1 ).wrapAt(36), labelWidth:50, numberWidth:35, layout: \vert);
		//listeView=listeView.add(~ag36);
		//~ag37= EZKnob(~wEditor, 50@100, "Control3", ControlSpec(0, 1, \lin, 0),
		//{arg view;
		//genome=~genomes.wrapAt(~agentEditor-1 );genome.wrapPut(37, view.value);~genomes.wrapPut(~agentEditor-1, genome);
		//~flagGene=37;
		//},
		//~genomes.wrapAt(~agentEditor-1 ).wrapAt(37), labelWidth:50, numberWidth:35, layout: \vert);
		...
		~wEditor.view.decorator.nextLine;
		~ag38= EZKnob(~wEditor, 225@25, "Audio Out", ControlSpec(1, ~sourceOutAgents.size, \lin, 1),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(38) * ~sourceOutAgents.size, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag38);
		~ag39= EZKnob(~wEditor, 225@25, "Midi Out", ControlSpec(0, 16, \lin, 1),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(39) * 15 + 1, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag39);
		/*StaticText(~wEditor, Rect(0, 0, 50, 18)).string_("Audio In");
		~ag40= PopUpMenu(~wEditor, 80@25).items_(~audioInLR);
		...
		~ag40 = EZKnob(~wEditor, 150@25, "Audio In", ControlSpec(0, ~audioInLR.size - 1, \lin, 1),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(40), false,  labelWidth: 60,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag40);
		~ag41= EZKnob(~wEditor, 225@25, "Loop Music", ControlSpec(-1, 1, \lin, 0),
			{arg view;
			...
			~genomes.wrapAt(~agentEditor-1 ).wrapAt(41) * 2 - 1, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag41);
		~ag42= EZKnob(~wEditor, 225@25, "Buffer Music", ControlSpec(1, 256, \lin, 1),{arg view;
		...
		~genomes.wrapAt(~agentEditor-1 ).wrapAt(42) * 256, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag42);
		~wEditor.view.decorator.nextLine;
		~ag43= EZKnob(~wEditor, 225@25, "Chord Max", ControlSpec(1, 12, \lin, 1),{arg view;
		...
		~genomes.wrapAt(~agentEditor-1 ).wrapAt(43) * 12, false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag43);
		~ag44= EZKnob(~wEditor, 225@25, "Chord Dur", ControlSpec(0.01, 1, \lin, 0),{arg view;
		...
		~genomes.wrapAt(~agentEditor-1 ).wrapAt(44), false,  labelWidth: 100,unitWidth: 0, layout: 'horz');
		listeView=listeView.add(~ag44);
		StaticText(~wEditor, Rect(0, 0, 50, 18)).string_("Algorithm");
		~ag45 = PopUpMenu(~wEditor, 100@25).items_(~listeAlgorithm);
		~ag45.action={arg algo;
			~fonctionRecordScore.value("~ag45", algo.value);
			genome=~genomes.wrapAt(~agentEditor-1);genome.wrapPut(45, algo.value / (~listeAlgorithm.size - 1).max(1));
			~genomes.wrapPut(~agentEditor-1, genome);
			~flagGene=45;
		};
			...
			if(agent >= 1 and: {agent <= ~agents},
				{listeView.do({arg v;
					if(v != nil, {
						...
						if(gene == 35, {v.value_([~genomes.wrapAt(agent-1).wrapAt(gene), ~genomes.wrapAt(agent-1).wrapAt(gene+1), ~genomes.wrapAt(agent-1).wrapAt(gene+2)])});
						if(gene == 36, {nil});
						if(gene == 37, {nil});
						...
						// Cas Normaux
						if(gene != 4 and: {gene != 5} and: {gene != 6} and: {gene != 11} and: {gene != 12} and: {gene != 13} and: {gene != 14} and: {gene != 15} and: {gene != 16} and: {gene != 18} and: {gene != 34} and: {gene != 35} and: {gene != 36} and: {gene != 37} and: {gene != 38} and: {gene != 39} and: {gene != 41} and: {gene != 42} and: {gene != 43} and: {gene != 45}, {v.valueAction_(~genomes.wrapAt(agent-1).wrapAt(gene))});
					});
					gene=gene+1});
			});
		};
