...
";
	...
	createGUI  {
		...
		fonctionWindowSynth={arg name, groupe, synthNumber, bufferOne, bufferTwo, canalIn, timeBuf1, timeBuf2, freezeOSC;
			...
			windowSynth.view.decorator.nextLine;
			// Auto Pan
			automationSliderPan = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["P", Color.black,  Color.green(0.8, 0.25)],["P", Color.black, Color.red(0.8, 0.25)], ["P", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Freq
			automationSliderFreq = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["F", Color.black,  Color.green(0.8, 0.25)],["F", Color.black, Color.red(0.8, 0.25)], ["F", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Translate
			automationSliderTrans = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["T", Color.black,  Color.green(0.8, 0.25)],["T", Color.black, Color.red(0.8, 0.25)], ["T", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Amp
			automationSliderAmp = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["A", Color.black,  Color.green(0.8, 0.25)],["A", Color.black, Color.red(0.8, 0.25)], ["A", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Dur
			automationSliderDur = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["D", Color.black,  Color.green(0.8, 0.25)],["D", Color.black, Color.red(0.8, 0.25)], ["D", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto stretch
			automationSliderStretch = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["S", Color.black,  Color.green(0.8, 0.25)],["S", Color.black, Color.red(0.8, 0.25)], ["S", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Quant
			automationSliderQuant = Button(windowSynth,Rect(0, 0, 12, 20)).states = [["Q", Color.black,  Color.green(0.8, 0.25)],["Q", Color.black, Color.red(0.8, 0.25)], ["Q", Color.black, Color.yellow(0.8, 0.25)]];
			// Auto Buffer
