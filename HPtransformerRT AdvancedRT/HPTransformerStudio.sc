/*
HPTransformerStudio V8.6.3 OSC temps reel et profils d usage for HPtransformerRT V30.2.3 - SuperCollider 3.14
...
HPTransformerStudio : Object {
    ...
    *new { |transformer, externalTransformerKey=\hpTR|
    ...
    build {
        // HPTransformer Studio Pro V8.6.3 PROFILS TEMPS REEL / HORS TEMPS REEL - HPtransformerRT V30.2.3 - SuperCollider 3.14
        ...
        var advancedRTText, normalizationToggle, multiResolutionToggle, stabilityToggle;
        var normalizationWarmupBox, midWindowBox, slowWindowBox, midDividerBox, slowDividerBox, snapshotIntervalBox;
        var refreshAdvancedRTControls, setAdvancedToggle, resetAdvancedRT;
        var displaysEnabled=true, logCollectionEnabled=true, displayToggleButton;
        var setDisplayMode;
        ...
        generalNames=["Equilibre","Apprentissage rapide","Stable","Exploration","Memoire forte",
         ...
         "Advanced RT - Prudent","Advanced RT - Equilibre","Advanced RT - Reactif",
         "Advanced RT - Multiresolution","Advanced RT - Stabilite maximale",
         "Intel Musical Direct","Intel Generation Only",
        ...
        generalPresets=[
         ...
         // Advanced RT prudent: normalisation legere, contexte lent discret, garde espacee.
         (learningRate:0.00014,gradientClip:0.35,replayRate:0.06,replayBatchSize:1,protectionStrength:0.28,normalizationEnabled:true,normalizationDecay:0.997,normalizationClip:3.0,normalizationBlend:0.08,normalizationWarmup:24,multiResolutionEnabled:true,multiResolutionMidWindow:24,multiResolutionSlowWindow:96,multiResolutionMidDivider:6,multiResolutionSlowDivider:24,multiResolutionMidGain:0.05,multiResolutionSlowGain:0.02,stabilityGuardEnabled:true,stabilitySnapshotInterval:192,stabilityLossLimit:0.80,stabilityLearningRateBackoff:0.55,autoTuneEnabled:false,metaLearnEnabled:false),
         // Advanced RT equilibre: profil conseille pour les quatre nouvelles fonctions.
         (learningRate:0.00022,gradientClip:0.45,replayRate:0.09,replayBatchSize:1,protectionStrength:0.22,normalizationEnabled:true,normalizationDecay:0.995,normalizationClip:3.0,normalizationBlend:0.12,normalizationWarmup:16,multiResolutionEnabled:true,multiResolutionMidWindow:24,multiResolutionSlowWindow:96,multiResolutionMidDivider:4,multiResolutionSlowDivider:16,multiResolutionMidGain:0.08,multiResolutionSlowGain:0.03,stabilityGuardEnabled:true,stabilitySnapshotInterval:128,stabilityLossLimit:1.0,stabilityLearningRateBackoff:0.50,autoTuneEnabled:false,metaLearnEnabled:false),
         // Advanced RT reactif: normalisation et contexte plus presents, garde plus frequente.
         (learningRate:0.00034,gradientClip:0.60,replayRate:0.05,replayBatchSize:1,protectionStrength:0.14,normalizationEnabled:true,normalizationDecay:0.990,normalizationClip:2.5,normalizationBlend:0.18,normalizationWarmup:12,multiResolutionEnabled:true,multiResolutionMidWindow:16,multiResolutionSlowWindow:64,multiResolutionMidDivider:3,multiResolutionSlowDivider:12,multiResolutionMidGain:0.11,multiResolutionSlowGain:0.035,stabilityGuardEnabled:true,stabilitySnapshotInterval:96,stabilityLossLimit:1.10,stabilityLearningRateBackoff:0.55,autoTuneEnabled:false,metaLearnEnabled:false),
         // Advanced multiresolution: contexte de phrase renforce, cadence encore bornee.
         (learningRate:0.00020,gradientClip:0.42,replayRate:0.10,replayBatchSize:1,protectionStrength:0.24,normalizationEnabled:true,normalizationDecay:0.996,normalizationClip:3.0,normalizationBlend:0.10,normalizationWarmup:20,multiResolutionEnabled:true,multiResolutionMidWindow:32,multiResolutionSlowWindow:128,multiResolutionMidDivider:4,multiResolutionSlowDivider:16,multiResolutionMidGain:0.14,multiResolutionSlowGain:0.06,stabilityGuardEnabled:true,stabilitySnapshotInterval:128,stabilityLossLimit:0.90,stabilityLearningRateBackoff:0.50,autoTuneEnabled:false,metaLearnEnabled:false),
         // Advanced stabilite maximale: apprentissage lent, snapshot rapproche, fort backoff.
         (learningRate:0.00010,gradientClip:0.28,replayRate:0.14,replayBatchSize:1,protectionStrength:0.48,normalizationEnabled:true,normalizationDecay:0.998,normalizationClip:2.5,normalizationBlend:0.08,normalizationWarmup:32,multiResolutionEnabled:true,multiResolutionMidWindow:24,multiResolutionSlowWindow:96,multiResolutionMidDivider:8,multiResolutionSlowDivider:32,multiResolutionMidGain:0.05,multiResolutionSlowGain:0.02,stabilityGuardEnabled:true,stabilitySnapshotInterval:64,stabilityLossLimit:0.60,stabilityLearningRateBackoff:0.35,autoTuneEnabled:false,metaLearnEnabled:false),
         (learningRate:0.00020,gradientClip:0.40,replayRate:0.04,replayBatchSize:1,protectionStrength:0.14,memoryRetrievalGain:0.07,memoryRecallSize:1,trajectoryRetrievalGain:0.05,trajectoryRecallSize:1,attentionTemperature:1.10,routerTemperature:1.00,deltaScale:0.32,trajectoryExplorationGain:0.004,diversityNoiseGain:0.00025,diversityRepulsionGain:0.0012,normalizationEnabled:false,multiResolutionEnabled:false,stabilityGuardEnabled:false,autoTuneEnabled:false,metaLearnEnabled:false),
         (learningRate:0.00016,gradientClip:0.35,replayRate:0.0,replayBatchSize:1,protectionStrength:0.12,memoryRetrievalGain:0.06,memoryRecallSize:1,trajectoryRetrievalGain:0.04,trajectoryRecallSize:1,attentionTemperature:1.20,routerTemperature:1.00,deltaScale:0.36,trajectoryExplorationGain:0.006,diversityNoiseGain:0.00040,diversityRepulsionGain:0.0018,normalizationEnabled:false,multiResolutionEnabled:false,stabilityGuardEnabled:false,autoTuneEnabled:false,metaLearnEnabled:false),
         // Base ultra-legere: adaptation rapide sans replay, rappel ni Advanced RT.
         (learningRate:0.00065,gradientClip:0.70,surpriseThreshold:0.030,surpriseGain:1.80,adaptationFastRate:2.20,adaptationSlowRate:0.55,replayRate:0.0,replayBatchSize:1,protectionStrength:0.08,memoryRetrievalGain:0.0,memoryRecallSize:0,trajectoryRetrievalGain:0.0,trajectoryRecallSize:0,generationWindowSize:2,attentionTemperature:1.15,routerTemperature:1.00,deltaScale:0.38,trajectoryExplorationGain:0.005,diversityNoiseGain:0.00030,diversityRepulsionGain:0.0012,normalizationEnabled:false,multiResolutionEnabled:false,stabilityGuardEnabled:false,autoTuneEnabled:false,metaLearnEnabled:false)
        ];
        ...
        generalProcessHz=Array.fill(15,{nil})++[20.0,60.0,50.0,40.0,30.0,10.0,20.0,15.0,20.0,15.0,25.0,20.0,30.0,40.0,25.0,15.0,20.0,20.0,20.0];
        generalLearnDivider=Array.fill(15,{nil})++[8,4,3,4,8,1,16,8,8,8,8,8,4,3,4,8,8,16,4];
        generalLearningState=Array.fill(15,{nil})++[true,true,true,true,false,true,false,true,true,true,false,true,true,true,true,true,true,false,true];
        generalGenerationState=Array.fill(15,{nil})++[true,true,true,true,true,false,true,true,true,true,true,true,true,true,true,true,true,true,true];
        ...
        setNames=[
         ...
         "Advanced RT Prudent","Advanced RT Equilibre","Advanced RT Expressif","Advanced RT Installation"
        ];
        setDescriptions=[
         ...
         "Nouvelles fonctions a charge minimale. Normalisation douce, multiresolution espacee, garde prudente et suivi par dimension proche du geste.",
         "Profil recommande. Equilibre entre adaptation, contexte de phrase, stabilite et suivi differencie des trois premieres sorties.",
         "Profil plus vivant. Normalisation reactive, contexte moyen renforce, garde active et davantage de liberte sur les dimensions expressives.",
         "Pour longue duree. Apprentissage lent, forte protection, contexte lent discret et snapshots stables plus frequents."
        ];
        ...
        setFollowMixes=[
         ...
         0.40, // Advanced RT Prudent, repli global
         0.35, // Advanced RT Equilibre, repli global
         0.25, // Advanced RT Expressif, repli global
         0.45  // Advanced RT Installation, repli global
        ];
        // Vecteurs 8D legers pour les jeux Advanced.
        ...
        w=Window("HPTransformer Studio Pro V8.6.3 - HPtransformerRT V30.2.3 - Profils temps reel et hors temps reel",uiRect.(35,35,1320,860)).background_(Color.grey(0.13));
        ...
        [
         [\dashboard,"Dashboard"],[\controls,"Controls"],[\advancedRT,"Advanced RT"],[\manualParams,"Parametres manuels"],[\morphing,"Morphing"],[\generation,"Generation Live"],[\memoryLive,"Memoire Live"],
        ...
        // Mode Scene: suspend all periodic GUI polling, plots and visual logs.
        setDisplayMode={|enabled|
         ...
         if(enabled,{
          ...
          {refresh.value;refreshAdvancedRTControls.value;refreshStateIndicators.value}.defer;
         },{
          oscDetailedEvents=false;
          if(oscDetailedButton.notNil,{oscDetailedButton.value_(0)});
        ...
        StaticText(pages[\dashboard],uiRect.(820,675,450,80)).string_(
         ...
         "Intel : 20 Hz, Learn/N=8, Details et controles auto OFF."
        ...
        // Advanced RT: optional controls; all processors remain OFF by default.
        setAdvancedToggle={|parameter,button,onLabel,offLabel|
         var enabled; enabled=(transformer.getParameter(parameter)==true).not;
         transformer.setParameter(parameter,enabled,false);
         button.states_([[if(enabled,{onLabel},{offLabel}),Color.white,if(enabled,{Color.green(0.42)},{Color.red(0.52)})]]);
         refreshAdvancedRTControls.value
        };
        refreshAdvancedRTControls={
         var nOn,mOn,sOn,status;
         nOn=(transformer.getParameter(\normalizationEnabled)==true);
         mOn=(transformer.getParameter(\multiResolutionEnabled)==true);
         sOn=(transformer.getParameter(\stabilityGuardEnabled)==true);
         if(normalizationToggle.notNil,{normalizationToggle.states_([[if(nOn,{"Normalisation ON"},{"Normalisation OFF"}),Color.white,if(nOn,{Color.green(0.42)},{Color.red(0.52)})]])});
         if(multiResolutionToggle.notNil,{multiResolutionToggle.states_([[if(mOn,{"Multiresolution ON"},{"Multiresolution OFF"}),Color.white,if(mOn,{Color.green(0.42)},{Color.red(0.52)})]])});
         if(stabilityToggle.notNil,{stabilityToggle.states_([[if(sOn,{"Stabilite ON"},{"Stabilite OFF"}),Color.white,if(sOn,{Color.green(0.42)},{Color.red(0.52)})]])});
         normalizationWarmupBox.value_(transformer.getParameter(\normalizationWarmup));
         midWindowBox.value_(transformer.getParameter(\multiResolutionMidWindow)); slowWindowBox.value_(transformer.getParameter(\multiResolutionSlowWindow));
         midDividerBox.value_(transformer.getParameter(\multiResolutionMidDivider)); slowDividerBox.value_(transformer.getParameter(\multiResolutionSlowDivider));
         snapshotIntervalBox.value_(transformer.getParameter(\stabilitySnapshotInterval));
         if(displaysEnabled,{status={transformer.advancedRealtimeStatus}.try;if(status.notNil,{advancedRTText.string_(status.asCompileString)})})
        };
        resetAdvancedRT={transformer.resetAdvancedRealtimeState;refreshAdvancedRTControls.value};
        title.(pages[\advancedRT],"ADVANCED RT - OPTIONNEL",20,15,600);
        normalizationToggle=button.(pages[\advancedRT],"Normalisation OFF",20,50,220,{setAdvancedToggle.(\normalizationEnabled,normalizationToggle,"Normalisation ON","Normalisation OFF")});
        addSlider.(pages[\advancedRT],"Decay",\normalizationDecay,ControlSpec(0.95,0.9999,\exp),20,95,580,6);
        addSlider.(pages[\advancedRT],"Clip",\normalizationClip,ControlSpec(1.0,6.0,\lin),20,135,580,4);
        addSlider.(pages[\advancedRT],"Blend",\normalizationBlend,ControlSpec(0.0,0.50,\lin),20,175,580,4);
        StaticText(pages[\advancedRT],uiRect.(20,220,180,24)).string_("Warmup :").stringColor_(Color.white);
        normalizationWarmupBox=NumberBox(pages[\advancedRT],uiRect.(205,216,120,30)).step_(1).clipLo_(1).clipHi_(512).action_({|b|transformer.setParameter(\normalizationWarmup,b.value.asInteger,false)});
        title.(pages[\advancedRT],"MULTIRESOLUTION",650,15,600);
        multiResolutionToggle=button.(pages[\advancedRT],"Multiresolution OFF",650,50,240,{setAdvancedToggle.(\multiResolutionEnabled,multiResolutionToggle,"Multiresolution ON","Multiresolution OFF")});
        addSlider.(pages[\advancedRT],"Gain moyen",\multiResolutionMidGain,ControlSpec(0.0,0.30,\lin),650,95,600,4);
        addSlider.(pages[\advancedRT],"Gain lent",\multiResolutionSlowGain,ControlSpec(0.0,0.20,\lin),650,135,600,4);
        StaticText(pages[\advancedRT],uiRect.(650,180,155,24)).string_("Fenetre moyenne :").stringColor_(Color.white);
        midWindowBox=NumberBox(pages[\advancedRT],uiRect.(810,176,100,30)).step_(1).clipLo_(2).clipHi_(512).action_({|b|transformer.setParameter(\multiResolutionMidWindow,b.value.asInteger,false)});
        StaticText(pages[\advancedRT],uiRect.(930,180,140,24)).string_("Fenetre lente :").stringColor_(Color.white);
        slowWindowBox=NumberBox(pages[\advancedRT],uiRect.(1070,176,100,30)).step_(1).clipLo_(8).clipHi_(2048).action_({|b|transformer.setParameter(\multiResolutionSlowWindow,b.value.asInteger,false)});
        StaticText(pages[\advancedRT],uiRect.(650,220,155,24)).string_("Diviseur moyen :").stringColor_(Color.white);
        midDividerBox=NumberBox(pages[\advancedRT],uiRect.(810,216,100,30)).step_(1).clipLo_(1).clipHi_(64).action_({|b|transformer.setParameter(\multiResolutionMidDivider,b.value.asInteger,false)});
        StaticText(pages[\advancedRT],uiRect.(930,220,140,24)).string_("Diviseur lent :").stringColor_(Color.white);
        slowDividerBox=NumberBox(pages[\advancedRT],uiRect.(1070,216,100,30)).step_(1).clipLo_(1).clipHi_(256).action_({|b|transformer.setParameter(\multiResolutionSlowDivider,b.value.asInteger,false)});
        title.(pages[\advancedRT],"GARDE DE STABILITE",20,285,600);
        stabilityToggle=button.(pages[\advancedRT],"Stabilite OFF",20,320,220,{setAdvancedToggle.(\stabilityGuardEnabled,stabilityToggle,"Stabilite ON","Stabilite OFF")});
        addSlider.(pages[\advancedRT],"Limite perte",\stabilityLossLimit,ControlSpec(0.10,10.0,\exp),20,365,580,4);
        addSlider.(pages[\advancedRT],"Backoff",\stabilityLearningRateBackoff,ControlSpec(0.10,1.0,\lin),20,405,580,4);
        StaticText(pages[\advancedRT],uiRect.(20,450,180,24)).string_("Intervalle snapshot :").stringColor_(Color.white);
        snapshotIntervalBox=NumberBox(pages[\advancedRT],uiRect.(205,446,120,30)).step_(1).clipLo_(8).clipHi_(4096).action_({|b|transformer.setParameter(\stabilitySnapshotInterval,b.value.asInteger,false)});
        button.(pages[\advancedRT],"Intel Musical Direct",350,445,195,{applyGeneralPreset.(31);refreshAdvancedRTControls.value});
        button.(pages[\advancedRT],"Intel Ultra CPU",555,445,175,{applyGeneralPreset.(33);refreshAdvancedRTControls.value});
        button.(pages[\advancedRT],"Tout desactiver",740,445,175,{transformer.setAdvancedRealtimeOff;refreshAdvancedRTControls.value});
        button.(pages[\advancedRT],"Reset etat",925,445,145,{resetAdvancedRT.value});
        button.(pages[\advancedRT],"Rafraichir",1080,445,145,{refreshAdvancedRTControls.value});
        title.(pages[\advancedRT],"DIAGNOSTIC",650,285,600);
        advancedRTText=TextView(pages[\advancedRT],uiRect.(650,320,600,110)).editable_(false).background_(Color(0.96,0.97,0.98)).stringColor_(Color.black).font_(Font("Monaco",10));
        StaticText(pages[\advancedRT],uiRect.(20,510,1230,70)).string_("Pour le temps reel Intel, laisser les trois interrupteurs sur OFF. Activez une fonction seulement pour un test cible.").stringColor_(Color.white);
        refreshAdvancedRTControls.value;
        ...
        [statusText,outputView,generationLiveText,memoryLiveText,surpriseLiveText,oscStatusText,oscEventsView,genPresetText,memoryPresetText,surprisePresetText,autoText,metaText,rcuText,logView,torusMaskStatus,setDescriptionView,manualParamsStatus,morphStatus,advancedRTText].do({|view|if(view.notNil,{view.background_(Color(0.96,0.97,0.98));view.stringColor_(Color.black);view.font_(Font.default.size_(12));view.refresh})});
        ...
        refresh={lastStatus={if(transformer.respondsTo(\statusSilent),{transformer.statusSilent},{transformer.status})}.try;if(lastStatus.notNil,{addGraphSample.(loss,lossEMA,lastStatus[\loss]);
         ...
         if(displaysEnabled and:{activePage==\advancedRT},{refreshAdvancedRTControls.value});
         refreshStateIndicators.value;
        ...
        w.onClose_({running=false;oscStop.value;if(routine.notNil,{routine.stop});window=nil;refreshRoutine=nil});refreshStateIndicators.value;showPage.(\dashboard);addLog.("Studio Pro V8.6.3 pour HPtransformerRT V30.2.3 ouvert - echelle "++uiScale);window=w;refreshRoutine=routine;scrollView.visibleOrigin_(Point(0,0));w.front;
    }
}
